...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:top-1/2 md:-translate-y-1/2 md:bottom-auto z-50 bg-[#0A0A0A]/80 backdrop-blur-2xl border border-cyan-500/20 shadow-[0_8px_32px_rgba(6,182,212,0.2)] rounded-3xl md:rounded-[40px] overflow-hidden pb-safe md:pb-0 transition-all duration-500">
